...
* Attach additional responsibilities to an object dynamically. 
   Decorators provided a flexible alternative to subclassing for extending functionality.
...
* Decorators are typically transparent to the client of the component—that is, 
